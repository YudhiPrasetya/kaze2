...
@section('content')
	...
	<p class="lead mt-4 text-800 text-sans-serif font-weight-semi-bold">@empty($message) {{ $httpStatusCode->getMessage($exception->getStatusCode()) }} @else {{ $message }} @endif</p>
	<hr />
	...
	<a class="btn btn-primary btn-sm mt-3" href="{{ route('login') }}"><i class="fas fa-home mr-2"></i>Go to login page</a>
@endsection