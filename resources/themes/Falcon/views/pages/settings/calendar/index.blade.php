...
@section('content')
	<x-bootstrap::row class="small-gutters">
		<x-bootstrap::column breakpoint="EXTRA_SMALL|8">
			<x-bootstrap::card>
				<x-bootstrap::card.header>
					<x-bootstrap::row class="row no-gutters align-items-center">
						...
						<x-bootstrap::column breakpoint="EXTRA_SMALL|auto;MEDIUM|auto" class="d-flex justify-content-end order-md-4">
							...
							<a class="btn btn-falcon-primary btn-sm" href="{{ route('settings.calendar.create') }}" {{--data-toggle="modal" data-target="#addEvent"--}}><i class="fad fa-calendar-plus mr-2"></i>Add Event</a>
						</x-bootstrap::column>
					</x-bootstrap::row>
				</x-bootstrap::card.header>
		...
		<x-bootstrap::column breakpoint="EXTRA_SMALL|4">
			<x-bootstrap::card>
				<x-bootstrap::card.header>
					<x-bootstrap::row class="row no-gutters align-items-center">
						<x-bootstrap::column>
							<h4 class="mb-0 fs-0 fs-sm-1 fs-lg-2 text-nunito font-weight-semi-bold">
								<span class="fad fa-glass-cheers text-red mr-2"></span>
								<span id="holiday-title">Holidays in {{ date('F Y') }}</span>
							</h4>
						</x-bootstrap::column>
					</x-bootstrap::row>
				</x-bootstrap::card.header>
				<x-bootstrap::card.body class="bg-light p-0 overflow-hidden">
					<div class="list-group list-group-flush font-weight-normal fs--1">
						<x-bootstrap::row class="no-gutters">
							<x-bootstrap::column id="event-list"></x-bootstrap::column>
						</x-bootstrap::row>
					</div>
				</x-bootstrap::card.body>
			</x-bootstrap::card>
