 ...
 * @date   2020-09-28 14:49:49
 */

if (!function_exists('getClassFullNameFromFile')) {
	/**
...
if (!function_exists('getClassObjectFromFile')) {
	/**
...
if (!function_exists('getClassNamespaceFromFile')) {
	/**
