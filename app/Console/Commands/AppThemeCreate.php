...
class AppThemeCreate extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	protected $signature = 'app:theme:create {name?}';
	...
	public function createStubs($themeStubFiles, $createdThemePath) {
		foreach ($themeStubFiles as $filename => $storePath) {
			...
			// $this->info($themeStubFile);
			// $this->info($createdThemePath . '/' . $storePath);
