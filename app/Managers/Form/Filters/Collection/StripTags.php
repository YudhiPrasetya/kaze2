...
class StripTags implements FilterInterface {
	 ...
	 *
	 * @return \App\Managers\Form\Filters\Collection\StripTags
	 */
	public function setAllowedAttributes($allowedAttribs): self {
	 ...
	 * @return string
	 */
	public function filterCertainTag($tag): string {
		// Parse the tag into:
